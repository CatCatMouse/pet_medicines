...
class ApparatusesService extends AdminBaseService
{
    ...
    {
        $model = MyModel::field('i.id,i.thumbnail,i.name,i.type type_true,i.type,factories.name factories_name,i.factory_id,brands.name brands_name,i.brand_id,i.times,i.imgs,i.status status_true,i.status,i.create_time,i.update_time,i.delete_time')
